...
namespace ImGui
{
    ...
    IMGUI_API void          SetWindowFontScale(float localScale);                                            // set font scale. Adjust IO.FontGlobalScale if you want to scale all windows. This is an old API! For correct scaling, prefer to reload font + rebuild ImFontAtlas + call style.ScaleAllSizes().
...
namespace ImGui
{
    ...
    static inline bool  IsAnyWindowOrItemHovered()                  { return IsWindowHovered(ImGuiHoveredFlags_AnyWindow); }
...
struct ImGuiTextFilter
{
    ...
    bool                IsEnabled() const { return !Filters.empty(); }
...
struct ImFont
{
    ...
    IMGUI_API const char*       CalcWordWrapPositionA(float localScale, const char* text, const char* text_end, float wrap_width) const;
